...
\begin{itemize}[style=standard, labelwidth=1.9cm]
    ...
    \item [09:00-09:30] \emph{(30min)} Introduction to EESSI: Motivation, Use Cases, Availability \& Access ways, Comparison with other package managers
%     \begin{itemize}
...
%     \end{itemize}
   \item [10:00-10:45] \emph{(45min)} Installing software on top of EESSI: Python virtual environments, using EESSI-extend (15 min. presentation + 30 min. hands-on).
    \item [10:45-11:00] \emph{(15min)} Using EESSI in Continuous Integration (CI) environments
    \item [11:00-11:30] \emph{(30min coffee break)}
